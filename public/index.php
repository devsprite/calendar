...
<div class="d-flex flex-row align-items-center justify-content-between mx-sm-3">
    ...
    <div>
        <a href="index.php?month=<?= $month->previousMonth()->getMonth(); ?>&year=<?= $month->previousMonth()->getYear(); ?>"
                ...
                <?php foreach ($month->days as $key => $day) :
                    ...
                    <td>
                        ...
                        <?php foreach ($eventsForDay as $event) : ?>
                            <div class="calendar__event"><?= (new DateTime($event['start']))->format('H:i'); ?> - <a
                                        href="event.php?id=<?= $event['id']; ?>"><?= h($event['name']); ?></a></div>
                        <?php endforeach; ?>
                    </td>
                <?php endforeach; ?>
            </tr>
